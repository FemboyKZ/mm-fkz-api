...
//
// TODO(cs2kz): when cs2kz-metamod exposes a per-player mode/time source,
// replace the null values with the seconds accrued in each mode since the last report,
