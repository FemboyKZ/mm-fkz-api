 ...
 * The result is delivered to an FKZ_ResponseCallback
 * with the HTTP status and the raw response body.
 *
...
void ApiTrampoline(bool success, int statusCode, const char *body,
                   uint32 /*bodyLen*/, void *userData) {
...
bool Dispatch(const char *method, const char *path, const char *body,
              FKZ_ResponseCallback cb, void *data) {
  if (!cb) {
...
bool GetCollection(const char *base, FKZ_ResponseCallback cb, int limit,
                   int offset, const char *sort, void *data) {
  return Dispatch("GET", Paged(base, limit, offset, sort).c_str(), nullptr, cb,
                  data);
}
} // namespace

// Core
bool FKZApi::ApiRequest(const char *method, const char *path, const char *body,
                        FKZ_ResponseCallback callback, void *data) {
...
bool FKZApi::PostServerStatus(const char *body, FKZ_ResponseCallback callback,
                              void *data) {
  return Dispatch("POST", "/servers/status", body, callback, data);
}

bool FKZApi::PostHibernate(const char *body, FKZ_ResponseCallback callback,
                           void *data) {
  return Dispatch("POST", "/servers/status/hibernate", body, callback, data);
}

// Live servers / players / maps
bool FKZApi::GetServers(FKZ_ResponseCallback callback, int limit, int offset,
                        const char *sort, void *data) {
  return GetCollection("/servers", callback, limit, offset, sort, data);
}

bool FKZApi::GetServer(const char *ip, FKZ_ResponseCallback callback,
                       void *data) {
  char path[128];
...
bool FKZApi::GetPlayers(FKZ_ResponseCallback callback, int limit, int offset,
                        const char *sort, void *data) {
  return GetCollection("/players", callback, limit, offset, sort, data);
}

bool FKZApi::GetOnlinePlayers(FKZ_ResponseCallback callback, int limit,
                              int offset, const char *sort, void *data) {
  return GetCollection("/players/online", callback, limit, offset, sort, data);
}

bool FKZApi::GetPlayer(const char *steamid, FKZ_ResponseCallback callback,
                       void *data) {
  char path[96];
...
bool FKZApi::GetMaps(FKZ_ResponseCallback callback, int limit, int offset,
                     const char *sort, void *data) {
  return GetCollection("/maps", callback, limit, offset, sort, data);
}

bool FKZApi::GetMap(const char *mapname, FKZ_ResponseCallback callback,
                    void *data) {
  char path[160];
...
// KZ Global - records
bool FKZApi::GetKzRecords(FKZ_ResponseCallback callback, int limit, int offset,
                          const char *sort, void *data) {
  return GetCollection("/kzglobal/records", callback, limit, offset, sort,
                       data);
}

bool FKZApi::GetKzRecentRecords(FKZ_ResponseCallback callback, int limit,
                                int offset, const char *sort, void *data) {
  return GetCollection("/kzglobal/records/recent", callback, limit, offset,
                       sort, data);
}

bool FKZApi::GetKzWorldRecords(FKZ_ResponseCallback callback, int limit,
                               int offset, const char *sort, void *data) {
  return GetCollection("/kzglobal/records/worldrecords", callback, limit,
                       offset, sort, data);
}

bool FKZApi::GetKzLeaderboard(const char *mapname,
...
// KZ Global - players
bool FKZApi::GetKzPlayers(FKZ_ResponseCallback callback, int limit, int offset,
                          const char *sort, void *data) {
  return GetCollection("/kzglobal/players", callback, limit, offset, sort,
                       data);
}

bool FKZApi::GetKzPlayer(const char *steamid, FKZ_ResponseCallback callback,
                         void *data) {
  char path[96];
...
bool FKZApi::GetKzPlayerRecords(const char *steamid,
                                FKZ_ResponseCallback callback, int limit,
                                int offset, const char *sort, void *data) {
  char base[128];
...
bool FKZApi::GetKzPlayerPBs(const char *steamid, FKZ_ResponseCallback callback,
...
bool FKZApi::GetKzPlayerCompletions(const char *steamid,
                                    FKZ_ResponseCallback callback, int limit,
                                    int offset, const char *sort, void *data) {
  char base[128];
...
// KZ Global - maps
bool FKZApi::GetKzMaps(FKZ_ResponseCallback callback, int limit, int offset,
                       const char *sort, void *data) {
  return GetCollection("/kzglobal/maps", callback, limit, offset, sort, data);
}

bool FKZApi::GetKzMap(const char *mapname, FKZ_ResponseCallback callback,
                      void *data) {
  char path[192];
...
bool FKZApi::GetKzMapRecords(const char *mapname, FKZ_ResponseCallback callback,
                             int limit, int offset, const char *sort,
                             void *data) {
  char base[192];
...
bool FKZApi::GetKzMapCourses(const char *mapname, FKZ_ResponseCallback callback,
                             int limit, int offset, const char *sort,
                             void *data) {
  char base[192];
...
// KZ Global - servers
bool FKZApi::GetKzServers(FKZ_ResponseCallback callback, int limit, int offset,
                          const char *sort, void *data) {
  return GetCollection("/kzglobal/servers", callback, limit, offset, sort,
                       data);
}
...
// KZ Global - bans
bool FKZApi::GetKzBans(FKZ_ResponseCallback callback, int limit, int offset,
                       const char *sort, void *data) {
  return GetCollection("/kzglobal/bans", callback, limit, offset, sort, data);
}

bool FKZApi::GetKzActiveBans(FKZ_ResponseCallback callback, int limit,
                             int offset, const char *sort, void *data) {
  return GetCollection("/kzglobal/bans/active", callback, limit, offset, sort,
                       data);
}
...
bool FKZApi::GetKzPlayerBans(const char *steamid, FKZ_ResponseCallback callback,
                             int limit, int offset, const char *sort,
                             void *data) {
  char base[96];
...
bool FKZApi::GetLocalMaps(FKZ_ResponseCallback callback, int limit, int offset,
                          const char *sort, void *data) {
  return GetCollection("/kzlocal/maps", callback, limit, offset, sort, data);
}

bool FKZApi::GetLocalMap(const char *mapname, FKZ_ResponseCallback callback,
                         void *data) {
  char path[160];
...
bool FKZApi::GetLocalRecords(FKZ_ResponseCallback callback, int limit,
                             int offset, const char *sort, void *data) {
  return GetCollection("/kzlocal/records", callback, limit, offset, sort, data);
}

bool FKZApi::GetLocalPlayers(FKZ_ResponseCallback callback, int limit,
                             int offset, const char *sort, void *data) {
  return GetCollection("/kzlocal/players", callback, limit, offset, sort, data);
}

// KZ Local CS2
bool FKZApi::GetLocalCS2Maps(FKZ_ResponseCallback callback, int limit,
                             int offset, const char *sort, void *data) {
  return GetCollection("/kzlocal-cs2/maps", callback, limit, offset, sort,
                       data);
}

bool FKZApi::GetLocalCS2Records(FKZ_ResponseCallback callback, int limit,
                                int offset, const char *sort, void *data) {
  return GetCollection("/kzlocal-cs2/records", callback, limit, offset, sort,
                       data);
}

bool FKZApi::GetLocalCS2Players(FKZ_ResponseCallback callback, int limit,
                                int offset, const char *sort, void *data) {
  return GetCollection("/kzlocal-cs2/players", callback, limit, offset, sort,
                       data);
}
